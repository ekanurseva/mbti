            ...
            <div class="d-flex">
                ...
                <div class="contents" style="margin: 75px 0; padding: 10px 40px;">
                    ...
                    <form method="post" action="">
                        <div class="mb-4 mt-5 row ms-5">
                            <label for="kode_gejala" class="col-sm-2 me-0 col-form-label">Gejala</label>
                            <div class="col-sm-7">
                        ...
                        <div class="mb-4 mt-2 row ms-5">
                            <label class="col-sm-2 me-0 col-form-label">Bobot</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" style="border: 1px solid black;"
                                    id="kode_gejala" name="bobot">
                            </div>
                        </div>

                        <div class="row justify-content-end">
                            <div class="col-sm-2 me-0">
                                <a href="../rule" class="btn btn-secondary">Kembali
                                </a>
                            </div>
                            <div class="col-sm-2 ms-0 p-0">
                                <button type="submit" class="btn btn-primary" name="rule">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
