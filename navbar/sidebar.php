        ...
        <div class="">
            <ul class="list-group list-group-flush pt-4 fw-medium">
                <li class="list-group-item">
                    <a href="../mbti/admin/data_admin.php" class="text-decoration-none d-block">
                        <span>Manajemen Data Admin</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/tipe_kepribadian" class="text-decoration-none d-block">
                        <span>Manajemen Tipe Kepribadian</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/tipe_mbti" class="text-decoration-none d-block">
                        <span>Manajemen Tipe MBTI</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/ciri-ciri" class="text-decoration-none d-block">
                        <span>Manajemen Ciri Tipe MBTI</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/saran" class="text-decoration-none d-block">
                        <span>Manajemen Saran Tipe MBTI</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/gejala" class="text-decoration-none d-block">
                        <span>Manajemen Gejala</span>
                    </a>
                </li>
                <li class="list-group-item">
                    <a href="../mbti/riwayat" class="text-decoration-none d-block">
