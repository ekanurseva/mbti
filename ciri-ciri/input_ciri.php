                        ...
                        <div class="mb-4 mt-2 row ms-5">
                            ...
                            <div class="col-sm-6">
                                <textarea type="text" style="border-color: black;" class="form-control" id="inputGejala"
                                    name="ciri" rows="6"></textarea>
                            </div>
                        </div>

                        <div class="row justify-content-end">
                            <div class="col-sm-2 me-0">
                                <a href="../ciri-ciri" class="btn btn-secondary">Kembali
                                </a>
                            </div>
...
<?php 
  if(isset($_POST['submit'])) {
    if (create($_POST) > 0) {
      $_SESSION["berhasil"] = "Data Ciri-Ciri MBTI Berhasil Ditambahkan!";
      ...
      ";
        ...
        echo "<script>
                Swal.fire(
                    'Gagal!',
                    'Data Ciri-Ciri MBTI Gagal Ditambahkan',
                    'error'
                )
            </script>";
        exit();
